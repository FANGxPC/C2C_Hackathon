    ...
    return (
      <div className="h-screen flex items-center justify-center bg-[var(--bg-page)]">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-[var(--text-primary)] mb-2">Student Hub</h2>
      ...
      case 'groups':
        return (
          <div className="p-6 flex items-center justify-center h-full">
            <div className="text-center">
              <h2 className="text-2xl font-semibold text-[var(--text-primary)] mb-2">Study Groups Coming Soon</h2>
              <p className="text-[var(--text-muted)]">Connect and collaborate with fellow students.</p>
            </div>
          </div>
        );
      case 'network':
        return (
          <div className="p-6 flex items-center justify-center h-full">
            <div className="text-center">
              <h2 className="text-2xl font-semibold text-[var(--text-primary)] mb-2">Network Coming Soon</h2>
              <p className="text-[var(--text-muted)]">Build your professional network.</p>
            </div>
          </div>
        );
      case 'companies':
        return (
          <div className="p-6 flex items-center justify-center h-full">
            <div className="text-center">
              <h2 className="text-2xl font-semibold text-[var(--text-primary)] mb-2">Companies Coming Soon</h2>
              <p className="text-[var(--text-muted)]">Explore career opportunities and company insights.</p>
            </div>
          </div>
        );
      default:
        if (currentPage.startsWith('materials/')) {
          ...
          return (
            <div className="p-6 flex items-center justify-center h-full">
              <div className="text-center">
                <h2 className="text-2xl font-semibold text-[var(--text-primary)] mb-2">Material Detail</h2>
                <p className="text-[var(--text-muted)]">Viewing material: {materialId}</p>
              </div>
            </div>
          );
        }
