...
export const Profile: React.FC = () => {
  ...
  const userProfile = {
    ...
    socialLinks: {
      github: 'https://github.com/FANGxPC/',
      linkedin: 'https://www.linkedin.com/in/md-sadique-46b54a330//',
              ...
              <div className="relative mx-auto mb-4">
                <Avatar className="h-24 w-24 mx-auto">
                  ...
                  <AvatarFallback className="bg-blue-100 text-blue-700 text-xl">
                    {userProfile.name.split(' ').map(n => n).join('')}
                  </AvatarFallback>
                </Avatar>
                <Button
                  size="sm"
