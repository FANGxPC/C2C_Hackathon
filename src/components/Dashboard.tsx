...
const motivationalQuotes = [
  ...
  },
  {
    ...
    icon: TrendingUp,
    gradient: "from-accent/15 to-secondary/10"
  },
  {
  ...
  return (
    <div className="p-6 space-y-8 min-h-full">
      ...
      <motion.div
        ...
        className="space-y-2"
      >
        <h1 className="text-3xl font-semibold text-foreground">Hi Fang 👋, here's your progress today.</h1>
      ...
      >
        ...
        >
          <Card className="shadow-sm animate-card-hover bg-gradient-to-br from-primary/5 to-accent/5 border border-primary/20">
